...
There are `r nrow(subset(ko, padj < 0.05))` genes different in the untreated
KO samples compared to the untreated WT samples.
...
There are `r nrow(subset(treatwt, padj < 0.05))` genes different in the
WT treated samples compared to the WT untreated samples.
...
There are `r nrow(subset(treatko, padj < 0.05))` genes different in the
KO treated samples compared to the KO untreated samples.
